...
<body>
  ...
  <main>
    ...
    <section id="about">
      ...
      $nim = 2511500089;
      $Nama = 'FARHEL ARIFQI';
      $tempat_tanggal_lahir = "TOBOALI, 7 MEI 2007"
      $pekerjaan ="MAHASISWA ATMA LUHUR"
      $orangtua ="NAMA BAPAK NINO PRIMADONA DAN IBU ARIANTI"
      $pasangan = "MUDAH MUDAHAN AJA"
      $hobi = "FUTSAL"
      $nama_adik = "FAKHIRA AQILA"
      ?>
      <h2>Tentang Saya</h2>
      <p><strong>NIM:</strong>
        <?php
      ...
      <p><strong>Nama Orang Tua:</strong> BAPAK NINO PRIMADONA IBU ARIANTI</p>
      <p><strong>Nama Adik:</strong> FAKHIRA AQILA</p>
    </section>
